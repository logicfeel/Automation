...
ALTER TABLE [sstory40].[MnAcct_Account] ADD  DEFAULT (getdate()) FOR [create_dt]
GO

ALTER TABLE [sstory40].[MnAcct_Account] ADD  DEFAULT ('N') FOR [del_yn]
GO

ALTER TABLE [sstory40].[MnAcct_Account] ADD  DEFAULT ('Y') FOR [using_yn]
GO
