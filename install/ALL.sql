...
-- ## 테스트 코드
/*
	SELECT DB_OBJ_iii.MnAuth_FN_AuthChk('1')
	SELECT DB_OBJ_iii.MnAuth_FN_AuthChk('777')
*/
...
/*
	SELECT DB_OBJ_iii.MnAuth_FN_AuthChk3('1')
	SELECT DB_OBJ_iii.MnAuth_FN_AuthChk3('777')
*/

-- DML SP
/*
exec DB_OBJ_iii.[MnAcct_Account_SP_C] 1, 'admin', 'admin', '관리자'

excute [DB_OBJ_iii].[MnAcct_Account_SP_C] 1, 'admin', 'admin', '관리자'

exec  @abc =  DB_OBJ_iii.[MnAcct_Account_SP_C]
exec @abc=DB_OBJ_iii.[MnAcct_Account_SP_C]
*/
