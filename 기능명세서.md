...
(.asp, .js ...)
- **확장성/편이성** : 폴더 및 파일의 자유로은 배치 (인스턴스모듈)
- **생산성** : 무한의 템플릿 제공
    - 코드 조각 : 코드의 일부 (FN, function, var... )
    - 추상화 모듈 : 코드의 묶음 (entity...)
...
3. 확장성 `7` : 환경의 변화을 개선의 반영
4. 편이성 `6` : 개발/디버깅 및 구조의 이해 편리함 제공
